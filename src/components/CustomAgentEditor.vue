  ...
  >
    <div class="bg-slate-900 border-2 border-purple-500 rounded-xl w-full max-w-lg shadow-2xl relative">
      ...
      <div class="p-6">
        ...
        <p class="text-xs text-slate-500 mb-6 uppercase tracking-widest">
          Define your automated persona
        </p>
        ...
        <div class="space-y-4">
          ...
          <div>
            ...
            <textarea
              v-model="customAgent.prompt"
              :maxlength="MAX_PROMPT_LEN"
              rows="4"
              data-testid="custom-agent-prompt"
              ...
              placeholder="e.g. Answer like a pirate. Be rude but funny."
            />
        ...
        <div class="mt-8 flex gap-3">
          <button
            v-if="mode === 'GENERATE'"
            :disabled="!customAgent.name"
            data-testid="custom-agent-generate-btn"
          ...
          <button
            data-testid="custom-agent-save-btn"
